...
const DEFAULT_COMMUNITY_PROJECTS: ProjectItem[] = [
  ...
  {
    id: 'comm-linear-equations',
    name: 'Linear Equations in One Variable',
    topic: 'Pre-Algebra & Foundations',
    goal: 'Master algebraic balance models, inverse operations, and word problem formulation',
    description: 'Class 8 pre-algebra core covering 10 fundamental concepts, 8 misconception taxonomies, distributive properties, and equation solving.',
    learning_budget: 40,
    icon: '📐',
    is_public: true,
    author: 'LearnForge Algebra Curriculum',
    likes_count: 175,
    clones_count: 112,
    tags: ['Mathematics', 'Algebra', 'Pre-Algebra'],
